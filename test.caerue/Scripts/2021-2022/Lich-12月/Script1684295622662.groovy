...
WebUI.sendKeys(findTestObject('Folder_Gerenal/choose_work_location/打刻時刻'), '1500')
...
WebUI.selectOptionByLabel(findTestObject('Folder_Gerenal/Choose_year_month_day/Choose_month2022_9'), '1月度', false)
