...
//2021-9-7
WebUI.click(findTestObject('Folder_Gerenal/1-31(day)/07'))
...
//2021-9-12
WebUI.click(findTestObject('Folder_Gerenal/1-31(day)/12'))
...
//2021-9-17
WebUI.click(findTestObject('Folder_Gerenal/1-31(day)/17'))
...
'※Thay đổi nếu lịch thay đổi'
WebUI.selectOptionByValue(findTestObject('Folder_Gerenal/choose_work_location/打刻日'), '2022-09-24', false)
...
'※Thay đổi nếu lịch thay đổi'
WebUI.selectOptionByValue(findTestObject('Folder_Gerenal/choose_work_location/打刻日'), '2022-09-25', false)
...
//2021-9-25
WebUI.click(findTestObject('Folder_Gerenal/1-31(day)/25'))
...
'※Thay đổi nếu lịch thay đổi'
WebUI.selectOptionByValue(findTestObject('Folder_Gerenal/choose_work_location/打刻日'), '2022-09-26', false)
...
'※Thay đổi nếu lịch thay đổi'
WebUI.selectOptionByValue(findTestObject('Folder_Gerenal/choose_work_location/打刻日'), '2022-09-27', false)
...
'※Thay đổi nếu lịch thay đổi'
WebUI.selectOptionByValue(findTestObject('Folder_Gerenal/choose_work_location/打刻日'), '2022-09-30', false)
